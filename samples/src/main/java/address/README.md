...
4. Name the Lambda Function "Address-API-Example-Skill".
...
8. Set the Handler as address.DeviceAddressSpeechletRequestStreamHandler (this refers to the Lambda RequestStreamHandler file in the zip).
